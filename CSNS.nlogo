...
;;Update and calculate the average friends of friends of each turtle, by getting the number of friends for each of the linked turtles
to update-average-friends-of-friends
  ask turtles [
    ...
    set num-friends-of-friends link-counts - 1
    ifelse num-friends != 0 [
      set average-friends-of-friends ( num-friends-of-friends / num-friends )
    ]
